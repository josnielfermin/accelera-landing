...
export default function SocialSidebar() {
  return (
    <div className="lg:absolute lg:-right-[72px] lg:-top-[168px] flex flex-col max-lg:flex-row max-lg:items-center max-lg:justify-center gap-4 z-10 max-[1720px]:bg-woodsmoke-950 py-6 px-4">
