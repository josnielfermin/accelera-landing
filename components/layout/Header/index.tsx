...
const ProductHeader = () => {
  ...
  return (
    <header className="w-full px-4 md:px-8 lg:px-16 relative overflow-hidden max-lg:bg-[#2F2F2F]/10 max-lg:backdrop-blur-[5.1px] h-[80px] max-lg:z-[10]">
      <div className="w-[120%] absolute bottom-0 left-[-10%] lg:h-[1.5px] h-[1px] bg-white lg:bg-opacity-50 bg-blend-overlay">
        {/* <div className="w-[70%] h-40 rounded-full blur-sm [background:radial-gradient(circle,_rgba(92,_222,_102,_1)_20%,_rgba(92,_222,_102,_0.43)_70%)] absolute top-1/2 -translate-y-1/2  max-lg:hidden left-1/2 -translate-x-1/2 animate-horizontal-light z-[100] bg-blend-overlay"></div> */}
      </div>
      <div
      ...
      >
        <Link
          href="/"
          className="flex items-center max-xxs:justify-end max-xxs:w-full relative pr-10 h-full  max-lg:ml-0 max-lg:absolute max-lg:top-1/2 max-lg:-translate-y-1/2 max-lg:left-0"
        >
          <Image
            src="/static/images/header/accelera-logo.png"
            alt="Accelera Logo"
        ...
        <div className="relative max-w-[245px] w-full lg:pl-10 lg:-left-10 max-lg:mr-5">
          ...
          {!isConnected ? (
            <Button
              ...
              className="max-[1865px]:mr-[31px] lg:max-w-[151px] xl2:max-w-[171px] max-lg:!w-[187px] whitespace-nowrap lg:!w-[245px]"
            >
              Connect your wallet
