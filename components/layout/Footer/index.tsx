  ...
  return (
    <footer className="w-full lg:py-6 lg:pt-6 lg:px-16 bg-[#2F2F2F]/30 border-t border-[#3B0A8F]/0 backdrop-blur-[6.44px] relative z-[2] max-lg:fixed max-lg:z-[100] max-lg:bottom-0">
      <div className="flex gap-2 justify-between max-lg:justify-center items-center container">
        <Link
          href="/"
          className="flex items-center max-xxs:justify-end max-xxs:w-full relative pr-10 h-full  max-lg:ml-0 max-lg:hidden"
        >
          <Image
        ...
        <div className="text-xs text-pastel-green-100 z-[5] max-lg:my-4">
          All rights reserved © Accelera
        </div>
        <div className="flex items-center gap-4 z-10 max-lg:hidden">
