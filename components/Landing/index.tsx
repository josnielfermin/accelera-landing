...
const Landing = () => {
  return (
    <main className="w-full h-full">
      ...
      <section className="relative w-full lg:min-h-[calc(100vh-140px)] max-lg:h-[750px] max-md:h-[820px] max-[380px]:h-[900px] flex flex-col max-lg:items-center lg:pl-12 container">
