  ...
  return (
    <main className="w-full h-full ">
      ...
      <section className="relative w-full lg:min-h-[calc(100vh-148px)] h-full flex flex-col max-lg:items-center container ">
        ...
        <TitleAnimation />
        <div className="flex items-start justify-between max-lg:flex-col lg:gap-8 lg:h-[66vh] lg:min-h-[508px] lg:!max-h-[600px] xl2:mt-[100px] lg:mt-[40px] max-lg:max-w-[90%] max-lg:w-full lg:relative">
          <LeftColumn />
          <Accelera />
          <RightColumn />
        </div>
