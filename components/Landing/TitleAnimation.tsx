...
const TitleAnimation = () => {
  ...
  return (
    <div className="lg:mt-10 relative h-[8rem] overflow-hidden flex items-center justify-center max-lg:justify-start max-lg:items-end w-full max-lg:max-w-[90%] z-[5]">
      <h1
