...
const TitleAnimation = () => {
  ...
  return (
    <div className="relative h-[8rem] overflow-hidden flex items-center justify-center">
      <h1
        className={`text-4xl md:text-8xl font-normal text-white absolute transition-all duration-500 h-[96px]`}
      >
        <div
          className={`${
            entry1 ? 'animate-slide-up-in' : 'animate-slide-up-out'
          } absolute left-1/2 -translate-x-1/2 w-full h-full flex items-center justify-center whitespace-nowrap gap-6`}
        >
