...
const TitleAnimation = () => {
  ...
  return (
    <div className="relative h-[8rem] overflow-hidden flex items-center justify-center max-lg:justify-start w-full max-lg:max-w-[90%] lg:top-10">
      <h1
        className={`max-lg:text-[26px] text-3xl min-[1070px]:text-4xl xl:text-5xl min-[1640px]:text-6xl font-normal text-white absolute transition-all duration-500 h-[96px]`}
      >
        <div
          className={`${
