...
const RightColumn = () => {
  ...
  return (
    <div className="relative flex max-lg:flex-col max-lg:items-center justify-center max-[1865px]:mr-[72px] max-lg:mx-auto w-full max-lg:mt-10 lg:max-w-[350px]">
      ...
      <div className="absolute -top-2.5 -left-2.5 bg-[#D9D9D9] w-4 h-4 max-lg:hidden z-[5]"></div>
      <div className="absolute -bottom-2.5 -right-2.5 bg-[#D9D9D9] w-4 h-4 max-lg:hidden z-[5]"></div>
