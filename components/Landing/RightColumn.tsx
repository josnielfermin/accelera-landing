...
const RightColumn = () => {
  ...
  return (
    <div className="relative flex max-lg:flex-col max-lg:items-center justify-center max-[1865px]:mr-[72px] max-lg:mx-auto w-full max-lg:mt-10 lg:max-w-[380px] lg:max-h-[450px]">
      ...
      <div className="bg-transparent rounded-none flex flex-col max-lg:flex-row max-md:flex-col w-full items-center">
        ...
        <div className="flex lg:flex-col max-[380px]:flex-col w-full items-center">
          <div className="relative w-full max-w-md lg:h-[280px] lg:-mt-10 mx-auto flex items-center justify-center overflow-hidden">
            {/* <SplineViewer
            ...
            /> */}
            <video
              className="w-full h-full lg:max-w-[350px] lg:max-h-[350px] absolute top-0 left-1/2 -translate-x-1/2 mix-blend-lighten z-[4] max-lg:hidden"
          ...
          <div className="flex flex-col w-full items-center max-lg:-ml-4 max-[380px]:ml-auto z-[6] relative">
            <h3 className="lg:text-4xl text-2xl font-normal lg:mb-1 text-white text-center">
      ...
      <div className="w-[1.5px] absolute bottom-0 right-0 2xl:h-[825px] h-[750px] bg-white bg-opacity-50 bg-blend-overlay z-[-9] max-lg:hidden overflow-hidden"></div>
