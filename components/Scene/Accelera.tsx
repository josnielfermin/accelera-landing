...
const Accelera = () => {
  return (
    <div className="absolute z-[2] h-[649px] w-[649px] max-xl2:w-[440px] max-xl2:h-[440px] lg:bottom-[30px] xl2:bottom-[20px] max-lg:top-[140px] xl:right-[300px] lg:right-[260px] min-[1600px]:right-[300px] right-0 mix-blend-lighten xl2:overflow-hidden max-lg:overflow-hidden">
      ...
      /> */}
      <video
        className="w-full h-full object-contain relative bottom-[-30px] max-xl2:bottom-[65px] max-[1870px]:right-10 max-lg:top-0 max-xxs:top-6 max-lg:right-0 max-sm:-right-20 max-xs:-right-40 max-xxs:-right-52 max-[280px]:-right-60"
