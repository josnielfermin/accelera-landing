...
const Accelera = () => {
  return (
    <div className="absolute h-[649px] w-[649px] max-xl2:w-[440px] max-xl2:h-[440px] lg:bottom-[30px] xl2:bottom-[20px] max-lg:top-[140px] xl:right-[300px] lg:right-[260px] min-[1600px]:right-[300px] right-0 mix-blend-lighten xl2:overflow-hidden max-lg:overflow-hidden">
